        ...
        <footer className="border-t border-slate-800 bg-slate-950 pt-16">
            <div className="mx-auto max-w-6xl px-4">
                ...
                <div className="mb-16 rounded-3xl bg-slate-900/50 border border-slate-800 p-8 md:p-12 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                        ...
                        <form onSubmit={handleSubscribe} className="flex w-full max-w-md flex-col gap-3 sm:flex-row relative">
                            <input
                                ...
                                className={`flex-1 rounded-xl border px-4 py-3 text-white placeholder:text-slate-500 focus:outline-none transition-all disabled:opacity-50 ${
                                    error 
                                    ? "border-red-500 bg-red-500/10 ring-1 ring-red-500" 
                                    : "border-slate-700 bg-slate-800/50 focus:border-vasta-primary focus:ring-1 focus:ring-vasta-primary"
                                }`}
                            />
                            <button 
                                type="submit"
                    ...
                    {/* Status Badge */}
                    {status === "success" && (
                        <div className="mt-8 flex items-center gap-4 border-t border-slate-800/50 pt-4 md:mt-0 md:border-0 md:pt-0 md:absolute md:bottom-8 md:right-12 lg:right-16 animate-fade-in-up">
                ...
                <div className="border-t border-slate-800 py-8">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <div className="flex gap-6 text-xs text-vasta-muted">
                            ...
                            <Link href="/legal/lgpd" className="hover:text-white">LGPD</Link>
                        </div>
                    </div>
                </div>
            </div>
