              ...
              <div className="relative overflow-hidden bg-white/5 backdrop-blur-sm lg:rounded-[2.5rem] lg:border lg:border-white/10 lg:shadow-2xl flex-1 flex flex-col">
                  ...
                  <div className="h-48 lg:h-64 w-full bg-black/10 relative shrink-0">
                       {cover_image ? (
                        ...
                        {/* Credits */}
                        {cover_image_credit && (
                           <div className="absolute bottom-3 right-3 px-2 py-0.5 bg-black/20 hover:bg-black/40 backdrop-blur-md rounded-md text-[9px] text-white/50 hover:text-white transition-all duration-300 z-20">
