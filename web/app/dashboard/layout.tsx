      ...
      >
          ...
          <div className="absolute top-0 left-0 right-0 h-32 bg-vasta-surface-soft overflow-hidden shrink-0">
            ...
            {settings.coverImageCredit && (
               <div className="absolute bottom-2 right-2 px-1.5 py-0.5 bg-black/20 backdrop-blur-md rounded text-[7px] text-white/50 pointer-events-none">
                  @{settings.coverImageCredit.includes(':') ? settings.coverImageCredit.split(':')[1] : settings.coverImageCredit}
               </div>
            )}
          </div>
