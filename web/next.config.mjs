        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self';",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://challenges.cloudflare.com https://vercel.live https://*.vercel.live https://js.stripe.com https://m.stripe.network https://*.vercel-scripts.com https://va.vercel-scripts.com;",
